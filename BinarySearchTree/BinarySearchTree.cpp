...
template<class ItemType>
ItemType BinarySearchTree<ItemType>::getEntry(const ItemType& anEntry)  throw(NotFoundException)
{
...
//////////////////////////////////////////////
//Added search and count function
/////////////////////////////////////////////


template<class ItemType>
int BinarySearchTree<ItemType>::findTargetAndCount( ItemType target)
{
	BinaryNode<ItemType>* node = findNode(rootPtr, target);
	return searchCount;
}